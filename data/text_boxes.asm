...
TextBoxCoordTable:
	...
	db LIST_MENU_BOX,     2,  2, 19, 12 ; shara-add: Edited to fit more tiles.
...
TextBoxTextAndCoordTable:
	...
	text_box_text USE_TOSS_MENU_TEMPLATE,             5, 10, 19, 14, UseTossText,              7, 11; shara-add: Edited to fit more tiles.
	...
	text_box_text BATTLE_MENU_TEMPLATE,               6, 12, 19, 17, BattleMenuText,           8, 14 ; shara-add: Edited to fit more tiles.
	;text_box_text SAFARI_BATTLE_MENU_TEMPLATE,        0, 12, 19, 17, SafariZoneBattleMenuText, 2, 14
	text_box_text SAFARI_BATTLE_MENU_TEMPLATE,        0, 12, 19, 17, SafariZoneBattleMenuText, 2, 14 ; shara-add: Edited to fit more tiles.
	;text_box_text SWITCH_STATS_CANCEL_MENU_TEMPLATE, 11, 11, 19, 17, SwitchStatsCancelText,   13, 12
	text_box_text SWITCH_STATS_CANCEL_MENU_TEMPLATE, 10, 11, 19, 17, SwitchStatsCancelText,   12, 12 ; shara-add: Edited to fit more tiles.
